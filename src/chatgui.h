...
private:
    ...
    // make _chatLogic an exclusive resource to class ChatbotPanelDialog using a smart pointer
    std::unique_ptr<ChatLogic> _chatLogic; // create a unique pointer on the stack
