        ...
        while (getline(file, lineStr))
        {
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    {
                        //// STUDENT CODE
                        //// Make sure that the instances of GraphNodes to which the vector elements refer are exclusively owned by the class ChatLogic
                        ...
                        {
                            // initialize a unique pointer without a pointer upon creation
                            std::unique_ptr<GraphNode> graphNodePtr;
                            // allocate the GraphNode to the dynamic memory and assign it to graphNodePtr pointer deleting the previously managed object
                            graphNodePtr.reset(new GraphNode(id));
                            // calling  push_back as normal will attempt to copy the unique_ptr into the vector
                            // as unique_ptrs cannot be copied, it has to be moved into the vector
